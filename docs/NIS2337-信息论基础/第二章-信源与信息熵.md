...
- **性质**：
    ...
    - 信源符号 $x_1,x_2,\cdots,x_n$，概率分布 $p_1,p_2,\cdots,p_n$
        
        - 编码方案 1：$-\log p_1,-\log p_2,\cdots,-\log p_n$ （按照码长 $I(x_{i}) = -\log p_{i}$ 进行编码），平均码长 $K_p = -\sum_{i} p_{i}\log p_{i}$ 

        - 编码方案 2：$-\log q_1,-\log q_2,\cdots,-\log q_n$，平均码长 $K_q = -\sum_{i} p_{i}\log q_{i}$ 
